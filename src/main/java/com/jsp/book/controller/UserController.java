...
public class UserController {
	...
	@GetMapping("/delete-seats/{id}")
	public String deleteSeats(@PathVariable Long id, HttpSession session, RedirectAttributes attributes) {
		return userService.deleteSeats(id, session, attributes);
	}
